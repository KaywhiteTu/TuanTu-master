...
class Login(Tk):
    ...
    def contact(self):
        ...
        Label(self.contact, text = 'Facebook: ', background = 'white').grid(row = 1, column = 0, sticky = 'w')
        Label(self.contact, text = '@user.tuantu.vo.dich.vu.tru', background = 'white').grid(row = 1, column = 1, sticky = 'w')

        Label(self.contact, text = 'Tiktok: ', background = 'white').grid(row = 2, column = 0, sticky = 'w')
        Label(self.contact, text = '@kaywhite99', background = 'white').grid(row = 2, column = 1, sticky = 'w')

        Label(self.contact, text = 'discord: ', background = 'white').grid(row = 3, column = 0, sticky = 'w')
        Label(self.contact, text = 'Tuấn Tú#1614', background = 'white').grid(row = 3, column = 1, sticky = 'w')

        Label(self.contact, text = 'Email: ', background = 'white').grid(row = 4, column = 0, sticky = 'w')
        Label(self.contact, text = 'kaywhitestream@protonmail.com', background = 'white').grid(row = 4, column = 1, sticky = 'w')
